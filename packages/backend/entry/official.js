...
var __reflect =
    ...
    DeBugTool = (function (_super) {
        function DeBugTool() {
            var e = _super.call(this) || this;
            return (
                (e._isOnline = !0), (e._day = ['周日', '周一', '周二', '周三', '周四', '周五', '周六']), (e.big = !1), e
            );
        }
        return (
            __extends(DeBugTool, _super),
            (DeBugTool.prototype.childrenCreated = function () {
                _super.prototype.childrenCreated.call(this), IS_RELEASE || this.initView();
            }),
            (DeBugTool.prototype.onOpenCloseBtn = function (e) {}),
            (DeBugTool.prototype.initView = function () {
                this.connecttest(),
                    this.addSysTime(),
                    this.addOpenModule(),
                    this.addAndroidScreenFullBtn(),
                    this.setVisible();
            }),
            (DeBugTool.prototype.onButtonClick1 = function (e) {
                window.SocketConnection.mainSocket.close();
            }),
            (DeBugTool.prototype.connecttest = function () {
                var e = this;
                (this.testbtn = new eui.Button()),
                    (this.testbtn.label = '断线测试!'),
                    (this.testbtn.horizontalCenter = 0),
                    (this.testbtn.verticalCenter = 0),
                    (this.testbtn.x = 400),
                    this.stage.addChild(this.testbtn),
                    this.testbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onButtonClick1, this),
                    (this.smallBtn = new eui.Button()),
                    (this.smallBtn.label = '！'),
                    (this.smallBtn.width = 20),
                    (this.smallBtn.height = 20),
                    (this.smallBtn.x = 200),
                    this.stage.addChild(this.smallBtn),
                    this.smallBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onButtonClick3, this),
                    (this.connectbtn = new eui.Button()),
                    (this.connectbtn.label = '重连测试!'),
                    (this.connectbtn.x = 550),
                    (this.connectbtn.verticalCenter = 0),
                    this.stage.addChild(this.connectbtn),
                    this.connectbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onButtonClick2, this),
                    (this.btnFPS = new eui.Button());
                var t = document.getElementById('egret-fps-panel');
                t && 'block' == t.style.display ? (this.btnFPS.label = '隐藏FPS') : (this.btnFPS.label = '显示FPS'),
                    (this.btnFPS.x = 700),
                    (this.btnFPS.y = 70),
                    this.stage.addChild(this.btnFPS),
                    this.btnFPS.addEventListener(
                        egret.TouchEvent.TOUCH_TAP,
                        function () {
                            '显示FPS' == e.btnFPS.label
                                ? (window.core.gameUtil.ShowFps(), (e.btnFPS.label = '隐藏FPS'))
                                : (window.core.gameUtil.hideFPS(), (e.btnFPS.label = '显示FPS'));
                        },
                        this
                    );
            }),
            (DeBugTool.prototype.onButtonClick3 = function (e) {
                (this.big = !this.big), this.setVisible();
            }),
            (DeBugTool.prototype.setVisible = function () {
                (this.testbtn.visible = this.big),
                    (this.connectbtn.visible = this.big),
                    (this.inputTx.visible = this.big),
                    (this.executeBtn.visible = this.big),
                    (this.timeTx.visible = this.big),
                    (this.btnFPS.visible = this.big),
                    (this.androidScreenFullBtn.visible = this.big),
                    this.big ? (this.updateTimer(), this._time.start()) : this._time.stop();
            }),
            (DeBugTool.prototype.onButtonClick2 = function (e) {
                this._isOnline
                    ? console.log('你尚未断开连接！（此提示仅限于测试按钮断线或者重连）')
                    : ((this._isOnline = !0), window.OnlineManager.getInstance().reconnect(!0));
            }),
            (DeBugTool.prototype.addSysTime = function () {
                (this.timeTx = new egret.TextField()),
                    (this.timeTx.text = '实例文本'),
                    (this.timeTx.width = 180),
                    (this.timeTx.size = 20),
                    (this.timeTx.textColor = 65280),
                    (this.timeTx.fontFamily = 'KaiTi'),
                    (this.timeTx.textAlign = egret.HorizontalAlign.CENTER),
                    (this.timeTx.verticalAlign = egret.VerticalAlign.TOP),
                    (this.timeTx.strokeColor = 255),
                    (this.timeTx.stroke = 2),
                    (this.timeTx.x = 220),
                    (this.timeTx.touchEnabled = !1),
                    this.stage.addChild(this.timeTx);
                var e = new egret.Timer(1e3);
                e.addEventListener(egret.TimerEvent.TIMER, this.ontimer, this), (this._time = e);
            }),
            (DeBugTool.prototype.ontimer = function (e) {
                this.updateTimer();
            }),
            (DeBugTool.prototype.updateTimer = function () {
                if (
                    window.SystemTimerManager &&
                    window.SystemTimerManager.sysBJDate &&
                    !isNaN(window.SystemTimerManager.sysBJDate.getTime())
                ) {
                    var e = window.SystemTimerManager.sysBJDate,
                        t = function (e) {
                            return 9 >= e ? '0' + e : e + '';
                        };
                    (this.timeTx.text =
                        ...
                        ' ' +
                        this._day[e.getDay()]),
                        window.OnlineManager.instance.currServerInfo &&
                            (this.timeTx.text += '\n服务器ID:' + window.OnlineManager.instance.currServerInfo.onlineID);
                } else this.timeTx.text = '暂未时间数据';
            }),
            (DeBugTool.prototype.addOpenModule = function () {
                (this.inputTx = new eui.TextInput()),
                    (this.inputTx.text = '@'),
                    (this.inputTx.x = 600),
                    (this.executeBtn = new eui.Button()),
                    (this.executeBtn.label = '点击打开'),
                    (this.executeBtn.x = this.inputTx.x + 300),
                    this.stage.addChild(this.inputTx),
                    this.stage.addChild(this.executeBtn),
                    this.inputTx.addEventListener(egret.Event.CHANGE, this.onInputCmd, this),
                    this.executeBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onExecuteBtn, this);
            }),
            (DeBugTool.prototype.addAndroidScreenFullBtn = function () {
                (this.androidScreenFullBtn = new eui.Button()),
                    (this.androidScreenFullBtn.label = '开启安卓全屏'),
                    (this.androidScreenFullBtn.flag = !1),
                    (this.androidScreenFullBtn.x = 900),
                    (this.androidScreenFullBtn.y = 70),
                    this.stage.addChild(this.androidScreenFullBtn),
                    this.androidScreenFullBtn.addEventListener(
                        egret.TouchEvent.TOUCH_TAP,
                        this._onChangeScreenFull,
                        this
                    );
            }),
            (DeBugTool.prototype._onChangeScreenFull = function () {
                var e = this.androidScreenFullBtn.flag;
                if (((this.androidScreenFullBtn.flag = !e), e)) {
                    this.androidScreenFullBtn.label = '退出安卓全屏';
            ...
            (DeBugTool.prototype.onInputCmd = function (e) {}),
            (DeBugTool.prototype.onExecuteBtn = function (e) {
                var txt = this.inputTx.text,
                    arg = txt.split(' ')[1],
                    args = txt.split(' ');
                if ('@' == txt.split('')[0]) {
                    for (var by = new egret.ByteArray(), len = txt.length, i = 0; len > i && !(by.length > 131); i++)
                        by.writeUTFBytes(txt.charAt(i));
                    by.writeUTFBytes('\x00'), window.SocketConnection.send(2102, 0, by.length, by);
                } else if ('#openview' === txt.split(' ')[0])
                    if (args.length >= 3) {
                        var params = args.slice(2, args.length).join('');
                        (params = eval('params = ' + params)), window.ModuleManager.showModuleByID(~~arg, params);
                    } else window.ModuleManager.showModuleByID(~~arg, null);
                else if ('#showBubble' == args[0]) {
                    if (args.length < 3) return void window.BubblerManager.getInstance().showText('参数错误');
                    window.ToolBarManager._mainPanel.showBubble(~~args[1], ~~args[2], args[3]);
                }
            }),
            DeBugTool
        );
    })(eui.Component);
__reflect(DeBugTool.prototype, 'DeBugTool');
var __reflect =
        (this && this.__reflect) ||
        function (e, t, n) {
            (e.__class__ = t), n ? n.push(t) : (n = [t]), (e.__types__ = e.__types__ ? n.concat(e.__types__) : n);
    ...
    Driver = (function () {
        ...
        return (
            (Driver.init = function (e, t, n) {
                e &&
                    e.length > 0 &&
                    ((Driver.configs = e), (Driver.callback = t), (Driver.thisObj = n), Driver.doAction());
            }),
                ...
                for (; l; )
                    try {
                        ...
                        switch (((o = 0), s && (n = [0, s.value]), n[0])) {
                            ...
                            default:
                                if (
                                    ((s = l.trys), !(s = s.length > 0 && s[s.length - 1]) && (6 === n[0] || 2 === n[0]))
                                ) {
                                    l = 0;
                                    continue;
                                }
                ...
                GameInfo.isApp &&
                    ...
                    (window.addEventListener('native.keyboardshow', function (i) {
                        ...
                        r || ((r = document.createElement('div')), (r.id = 'bg'), document.body.appendChild(r)),
                            console.log('keyboardheight:' + i.keyboardHeight),
                            (r.style.height = e + i.keyboardHeight + 'px'),
                            0 == n &&
                                window.setTimeout(function () {
                                    e - t - i.keyboardHeight < 15 &&
                                        ((n = i.keyboardHeight - (e - t) + 30),
                                        console.log(
                                            'innerheight:' +
                                                e +
                                                ' eventY:' +
                    ...
                    (t.prototype.onerror = function () {
                        ...
                        navigator.onLine
                            ? this.retryTimes < e
                                ...
                                : (window.Sentry && window.Sentry.captureMessage('资源加载失败:' + this._url),
                                  i.call(this))
                            : egret.setTimeout(
                                  function () {
                                      t.abort(), t.open(t._url, t._method), t.send();
...
var __reflect =
    ...
    FileSystemUtil = (function () {
        function e() {}
        return (
            (e.requestFileSystem = function (e, t) {
                var n = this;
                return (
                    void 0 === e && (e = 0),
                    new Promise(function (i, r) {
                        void 0 === t && (t = LocalFileSystem.PERSISTENT),
                            window.requestFileSystem(
                                ...
                                function (e) {
                                    return r(n.errDesc(e));
                                }
                            );
                    })['catch'](function (e) {
                        throw (e.code && n.errDesc(e), e);
                    })
                );
            }),
            (e.resolveLocalFileSystemURL = function (e) {
                return new Promise(function (t, n) {
                    e &&
                        -1 == e.indexOf(':') &&
                        ((e = e.replace(/[\\\/]+/g, '/')),
                        ...
                        (e =
                            1 == GameInfo.platform
                                ? cordova.file.externalDataDirectory + e
                                : cordova.file.documentsDirectory + e)),
            ...
            (e.resolveLocalRootFileSystemURL = function (t) {
                var n = this;
                return new Promise(function (i, r) {
                    var o,
                        s = { path: null, root: null };
                    (o = t.match(/(cdvfile:\/\/\w+\/\w+(?:\/)?)(.*)?/i))
                        ? ((s.path = o[2] || ''),
                          n.resolveLocalFileSystemURL(o[1]).then(
                              function (e) {
                                  (s.root = e), i(s);
                              },
                              function (e) {
                        ...
                        : ((s.path = t), (s.root = e.fs.root), i(s));
                });
            }),
            (e.save = function (t, n, i) {
                var r = this;
                void 0 === i && (i = !1);
                var o = function (e, t) {
                                    ...
                                    function (t) {
                                        if (
                                            ...
                                            try {
                                                ...
                                                return o(new Error("file doesn't exist!"));
                                            }
                                        t.write(n);
                                    },
                                    function (e) {
                ...
                return this.resolveLocalRootFileSystemURL(t)
                    .then(function (n) {
                        if (((t = t.slice(-n.path.length)), t.search(/[\\\/]+/) >= 0)) {
                            var i = t.split(/[\\\/]+/),
                                r = i.pop();
                            if ('' == r) throw new Error('保存的文件名不能为空.');
                            return e.createDirectory(i.join('/'), n.root.toURL()).then(function (e) {
                                return o(e, r);
                            });
                        }
                        return o(n.root, n.path);
                    })
                    ['catch'](function (e) {
                        throw (e.code && r.errDesc(e), e);
                    });
            }),
            (e.read = function (t, n) {
                var i = this;
                return this.resolveLocalFileSystemURL(t)
                    .then(function (i) {
                        return new Promise(function (r, o) {
                            (n = n || e.getTypeByUrl(t)),
                                i.file(
                                    function (e) {
                                        ...
                                        switch (
                                            ...
                                            case RES.ResourceItem.TYPE_JSON:
                                                t.readAsText(e);
                                                break;
                                            case RES.ResourceItem.TYPE_TEXT:
                                                t.readAsText(e);
                                                break;
                                            case RES.ResourceItem.TYPE_FONT:
                                                t.readAsText(e);
                                                break;
                    ...
                    ['catch'](function (e) {
                        throw (e.code && i.errDesc(e), e);
                    });
            }),
            (e.remove = function (e) {
                var t = this;
                return this.resolveLocalFileSystemURL(e)
                    .then(function (e) {
                        return new Promise(function (t, n) {
                            e.remove(
                                function () {
                    ...
                    ['catch'](function (e) {
                        throw (e.code && t.errDesc(e), e);
                    });
            }),
            (e.exists = function (e) {
                var t = this;
                return new Promise(function (n, i) {
                    t.resolveLocalFileSystemURL(e).then(
                        function (e) {
                            n(!0);
                        },
                        function () {
            ...
            (e.file = function (e) {
                var t = this;
                return this.resolveLocalFileSystemURL(e)['catch'](function (e) {
                    throw (e.code && t.errDesc(e), e);
                });
            }),
            (e.md5 = function (e) {
                ...
                return new Promise(function (n, i) {
                    t.file(e).then(function (e) {
                        ...
                        window.md5chksum.file(e, t, r);
                    });
                });
            }),
            (e.createDirectory = function (e, t) {
                var n = this;
                return new Promise(function (i, r) {
                    i(
                        t
                            ? n.resolveLocalFileSystemURL(t)
                            : n.resolveLocalRootFileSystemURL(e).then(function (t) {
                                  return (e = t.path), t.root;
                              })
                    );
                })
                    .then(function (t) {
                        var n = e.split(/[\\\/]+/);
                        n.length && 'file:' == n[0] && n.shift();
                        var i = function (e, t) {
                            return !t || t.length <= 0
                                ? e
                                : '' == t[0]
            ...
            (e.test = function (t) {
                var n = this;
                return (
                    void 0 === t && (t = 'cdvfile://localhost/persistent/'),
                    '/' != t.charAt(t.length - 1) && (t += '/'),
                    new Promise(function (e) {
                        e();
                    })
                        .then(function (t) {
                            return console.log('当前默认存储目录:"' + e.fs.root.nativeURL + '"');
                        })
                        .then(function () {
                            return n.createDirectory(t + 'test/');
                        })
                        .then(function (e) {
                            return console.log('1:创建目录"' + t + 'test/"'), e;
                        })
                        .then(function () {
                            return n.save(t + 'test/test1/test2/file.txt', '测试');
                        })
                        .then(function (e) {
                            return console.log('2:保存文件"' + t + 'test/test1/test2/file.txt" => 写入:"测试"'), e;
                        })
                        .then(function () {
                            return n.read(t + 'test/test1/test2/file.txt', RES.ResourceItem.TYPE_TEXT);
                        })
                        .then(function (e) {
                            return console.log('3:读取文件"' + t + 'test/test1/test2/file.txt" => 读取:"' + e + '"'), e;
                        })
                        .then(function () {
                            return n.md5(t + 'test/test1/test2/file.txt');
                        })
                        .then(function (e) {
                            return console.log('4:生成md5值"' + t + 'test/test1/test2/file.txt" => md5:"' + e + '"'), e;
                        })
                        .then(function () {
                            return n.remove(t + 'test/test1/test2/file.txt');
                        })
                        .then(function (e) {
                            return console.log('5:删除文件"' + t + 'test/test1/test2/file.txt"'), e;
                        })
                        .then(function () {
                            return n.exists(t + 'test/test1/test2/file.txt');
                        })
                        .then(function (e) {
                            return (
                                console.log(
                        ...
                        .then(function () {
                            return n.remove(t + 'test/test1/test2/');
                        })
                        .then(function (e) {
                            return console.log('7:删除目录"' + t + 'test/test1/test2/"'), e;
                        })
                        .then(function () {
                            return n.exists(t + 'test/test1/test2/');
                        })
                        .then(function (e) {
                            return (
                                console.log(
                                    '8:检查目录"' + t + 'test/test1/test2/" ' + (e ? '目录存在!' : '目录不存在!')
                                ),
                                e
                            );
                        })
                        .then(function () {
                            return n.remove(t + 'test/test1/');
                        })
                        .then(function (e) {
                            return console.log('9:删除目录"' + t + 'test/test1/"'), e;
                        })
                        .then(function () {
                            return n.remove(t + 'test/');
                        })
                        .then(function (e) {
                            return console.log('10:删除目录"' + t + 'test/"'), e;
                        })
                        .then(function () {
                            return n.resolveLocalRootFileSystemURL(t + 'test/test/test/test/test/test.txt');
                        })
                        .then(function (e) {
                            return console.log('11:提取文件根目录 "' + t + 'test/test/test/test/test/test.txt ', e), e;
                        })
                        ['catch'](function (e) {
            ...
            (e.getTypeByUrl = function (e) {
                ...
                if (t) {
                    var n = t.lastIndexOf('?');
                    -1 != n && (t = t.substr(0, n)), (t = t.toLowerCase());
                }
                var i;
                switch (t) {
                    case RES.ResourceItem.TYPE_XML:
...
__reflect(FileSystemUtil.prototype, 'FileSystemUtil');
var __reflect =
        (this && this.__reflect) ||
        function (e, t, n) {
            (e.__class__ = t), n ? n.push(t) : (n = [t]), (e.__types__ = e.__types__ ? n.concat(e.__types__) : n);
...
var __reflect =
    ...
    SeerVersionController = (function () {
        function e() {}
        return (
            ...
            (e.getVersionUrl = function (t) {
                ...
                if (GameInfo.isApp) {
                    ...
                    if ('10000' != h && r.length > 0) {
                        if (0 == a.length)
                            return (t =
                                cordova.file.applicationDirectory + 'www/' + t.replace(i, c + '_' + r + '.' + u));
                        if (c + '_' + r + '.' + u == a)
                            return (t =
                                cordova.file.applicationDirectory + 'www/' + t.replace(i, c + '_' + r + '.' + u));
    ...
    ThemeAdapter = (function () {
        ...
        return (
            (e.prototype.getTheme = function (e, t, n, i) {
                ...
                function o(t) {
                    t.resItem.url == e &&
                        (RES.removeEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, o, null), n.call(i));
                }
                var s = this;
