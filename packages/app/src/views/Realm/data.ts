import { MoveStrategy, NoBloodSwitchLink, Operator, SkillNameMatch, generateStrategyByName } from 'sa-core';
...
const data: LevelPetsData = {
    ...
    LevelElfKingsTrial: {
        ...
        strategy: generateStrategyByName(['竭血残蝶', '剑挥四方', '破寂同灾'], ['幻影蝶', '六界帝神', '深渊狱神·哈迪斯']),
    },
};
