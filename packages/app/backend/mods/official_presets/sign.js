...
var m = (y, s, u) => (tt(y, typeof s != "symbol" ? s + "" : s, u), u);
const L = {
  刻印抽奖次数: 16577,
  登录时长: 12462,
  已许愿次数: 12231,
...
class et {
  constructor() {
    ...
    m(this, "export", {
      刻印抽奖: {
        check: async () => +!(await sac.Socket.multiValue(L.刻印抽奖次数))[0],
      ...
      许愿签到: {
        check: async () => +!(await sac.Socket.multiValue(L.许愿签到))[0],
        run: async () => {
          const s = (await sac.Socket.multiValue(L.许愿签到天数))[0];
          sac.Socket.sendByQueue(45801, [s, 1]);
        }
      }
    });
  }
...
class nt {
  constructor() {
    ...
    m(this, "defaultConfig", { ignorePets: [] });
    m(this, "config");
    m(this, "export", {
      战队派遣: {
...
class at {
  constructor() {
    ...
    m(this, "defaultConfig", { exchangeId: it.战队道具.不灭能量珠 });
    m(this, "config");
    m(this, "export", {
      生产资源: {
        check: async () => {
...
class ot {
  constructor() {
    ...
    m(this, "defaultConfig", { exchangeId: rt.vip点数.体力上限药 });
    m(this, "config");
    m(this, "export", {
      领取vip箱子: {
      ...
      return n.parse = function(t) {
        this.$d = function(a) {
          ...
          if (typeof e == "string" && !/Z$/i.test(e)) {
            var r = e.match(J);
            if (r) {
              var h = r[2] - 1 || 0, l = (r[7] || "0").substring(0, 3);
              return o ? new Date(Date.UTC(r[1], h, r[3] || 1, r[4] || 0, r[5] || 0, r[6] || 0, l)) : new Date(r[1], h, r[3] || 1, r[4] || 0, r[5] || 0, r[6] || 0, l);
            }
          }
          return new Date(e);
        ...
        var e = this, o = !!c.u(a) || a, r = c.p(t), h = function(x, M) {
          var T = c.w(e.$u ? Date.UTC(e.$y, M, x) : new Date(e.$y, M, x), e);
          return o ? T : T.endOf(w);
        }, l = function(x, M) {
        ...
        var e, o = c.p(t), r = "set" + (this.$u ? "UTC" : ""), h = (e = {}, e[w] = r + "Date", e[Y] = r + "Date", e[S] = r + "Month", e[I] = r + "FullYear", e[g] = r + "Hours", e[_] = r + "Minutes", e[v] = r + "Seconds", e[B] = r + "Milliseconds", e)[o], l = o === w ? this.$D + (a - this.$W) : a;
        if (o === S || o === I) {
          var f = this.clone().set(Y, 1);
          f.$d[h](l), f.init(), this.$d = f.set(Y, Math.min(this.$D, f.daysInMonth())).$d;
        } else
          h && this.$d[h](l);
        ...
        if (r === d)
          return h(7);
        var l = (e = {}, e[_] = k, e[g] = D, e[v] = u, e)[r] || 1, f = this.$d.getTime() + t * l;
        return c.w(f, this);
        ...
        var o = t || "YYYY-MM-DDTHH:mm:ssZ", r = c.z(this), h = this.$H, l = this.$m, f = this.$M, p = e.weekdays, O = e.months, b = function(M, T, R, U) {
          return M && (M[T] || M(a, o)) || R[T].slice(0, U);
        }, N = function(M) {
          return c.s(h % 12 || 12, M, "0");
        }, W = e.meridiem || function(M, T, R) {
          var U = M < 12 ? "AM" : "PM";
          return R ? U.toLowerCase() : U;
        }, x = { YY: String(this.$y).slice(-2), YYYY: c.s(this.$y, 4, "0"), M: f + 1, MM: c.s(f + 1, 2, "0"), MMM: b(e.monthsShort, f, O, 3), MMMM: b(O, f), D: this.$D, DD: c.s(this.$D, 2, "0"), d: String(this.$W), dd: b(e.weekdaysMin, this.$W, p, 2), ddd: b(e.weekdaysShort, this.$W, p, 3), dddd: p[this.$W], H: String(h), HH: c.s(h, 2, "0"), h: N(1), hh: N(2), a: W(h, l, !0), A: W(h, l, !1), m: String(l), mm: c.s(l, 2, "0"), s: String(this.$s), ss: c.s(this.$s, 2, "0"), SSS: c.s(this.$ms, 3, "0"), Z: r };
        return o.replace(Z, function(M, T) {
          return T || x[M] || r.replace(":", "");
        });
      }, n.utcOffset = function() {
        return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
      }, n.diff = function(t, a, e) {
        var o, r = c.p(a), h = $(t), l = (h.utcOffset() - this.utcOffset()) * k, f = this - h, p = c.m(this, h);
        return p = (o = {}, o[I] = p / 12, o[S] = p, o[X] = p / 3, o[d] = (f - l) / 6048e5, o[w] = (f - l) / 864e5, o[g] = f / D, o[_] = f / k, o[v] = f / u, o)[r] || f, e ? p : c.a(p);
...
class ft {
  constructor() {
    ...
    m(this, "config");
    m(this, "subDaysWY", A().diff(A("2023-06-01"), "d"));
    m(this, "subDaysWXC", A().diff(A("2023-06-08"), "d"));
    m(this, "export", {
      主题站签到: {
